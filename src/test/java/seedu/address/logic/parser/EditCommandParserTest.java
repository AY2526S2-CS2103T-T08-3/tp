...
import static seedu.address.logic.commands.CommandTestUtil.VALID_DELIVERY_STATUS_AMY;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_DELIVERY_STATUS_DESC,
                DeliveryStatus.MESSAGE_CONSTRAINTS); // invalid delivery status
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + ORDER_DESCRIPTION_DESC_AMY
                + EXPIRY_DATE_DESC_AMY + DELIVERY_STATUS_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + EMAIL_DESC_AMY + EXPIRY_DATE_DESC_AMY;
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // delivery status
        userInput = targetIndex.getOneBased() + DELIVERY_STATUS_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withDeliveryStatus(VALID_DELIVERY_STATUS_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                + ORDER_DESCRIPTION_DESC_AMY + EXPIRY_DATE_DESC_AMY + DELIVERY_STATUS_DESC_AMY + TAG_DESC_FRIEND
                + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + PHONE_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + ORDER_DESCRIPTION_DESC_BOB
                + EXPIRY_DATE_DESC_BOB + DELIVERY_STATUS_DESC_BOB + TAG_DESC_HUSBAND;
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC
                + INVALID_ORDER_DESCRIPTION_DESC + INVALID_EXPIRY_DATE_DESC + INVALID_DELIVERY_STATUS_DESC
